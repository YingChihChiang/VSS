	...
	double *ch, double *wa1, double *wa2, double *wa3)
{
    ...
    /* Local variables */
     int i, k;
     double ci2, ci3, ci4, cr2, cr3, cr4, ti1, ti2, ti3, ti4, tr1, 
	    tr2, tr3, tr4;
	...
	double *wa4)
{
    /* Initialized data */
     ...
     double tr11 = .309016994374947;
     double ti11 = .951056516295154;
     double tr12 = -.809016994374947;
     double ti12 = .587785252292473;
    ...
    /* Local variables */
     int i, k;
     double ci2, ci3, ci4, ci5, di3, di4, di5, di2, cr2, cr3, cr5, 
	...
	double *ch, double *ch2, double *wa)
{
    ...
    /* Local variables */
     int idij, idlj, idot, ipph, i, j, k, l, jc, lc, ik, nt, idj, 
	    idl, inc, idp;
     double wai, war;
     int ipp2;
